    ...
    <div class="footer-article">
        <div class="wrap-content wap_footer">
            <div class="footer-news" id="main_footer">
                ...
                <?php /* ?>
                <ul>
                    <li><i class="fas fa-map-marker-alt"></i><?=$optsetting['diachi']?></li>
                    <li><i class="fas fa-phone-volume"></i><?=$optsetting['dienthoai']?></li>
                    <li><i class="fas fa-envelope"></i><?=$optsetting['email']?></li>
                    <li><i class="fas fa-globe"></i><?=$optsetting['website']?></li>
                </ul><?php */ ?>
