<?php
	...
	function save_item_admin()
	{
		...
		if(!empty($check_username)) $func->transfer("Tên đăng nhập nay đã tồn tại. Xin chọn tên khác", "index.php?com=user&act=man_admin&p=".$curPage, false);
	...
	function save_item()
	{
		...
		if(!empty($check_username)) $func->transfer("Tên đăng nhập nay đã tồn tại. Xin chọn tên khác", "index.php?com=user&act=man&p=".$curPage, false);
